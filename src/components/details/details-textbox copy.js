...
class DetailsTextbox extends HTMLElement {
    ...
    render() {
        ...
        const crewName = this.getAttribute('crewName') || ''
        const crewimgurl = this.getAttribute('crewimgurl') || ''
        const castJob = this.getAttribute('castJob') || ''
        const castName = this.getAttribute('castName') || ''
        const castImgUrl = this.getAttribute('castImgUrl') || ''
