 ...
 <nav class="gnb">
    ...
    <h1>
       <svg width="130" height="30" viewBox="0 0 130 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="a11y-hidden">videOn</span>
      </h1>
     </a>
    </div>
    <ul class="gnb--menu">
    ...
    <div class="gnb--favorite">
      ...
      <span class="a11y-hidden">my-favorite</span>
    </div>
    ...
    <div class="gnb--search">
        <button class="gnb--search-button">
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span class="a11y-hidden">search-button</span>
        </button>
  ...
  addEventListeners() {
    ...
    const favoriteButton = this.querySelector(".gnb--favorite");
    ...
    // favorite 버튼 클릭시 liked-page로 이동
    favoriteButton.addEventListener("click", () => {
      window.location.href = `liked-page.html`;
    });
